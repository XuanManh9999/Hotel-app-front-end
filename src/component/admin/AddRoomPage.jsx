...
const AddRoomPage = () => {
    ...
    const addRoom = async () => {
        if (!roomDetails.photo || !roomDetails.roomType || !roomDetails.roomPrice || !roomDetails.roomDescription) {
        ...
        <div className="edit-room-container">
            ...
            <div className="edit-room-form">
                ...
                <div className="form-group">
                    ...
                    <select className='room-type' value={roomDetails.roomType} onChange={handleRoomTypeChange}>
